	...
	RBTNode* uncle = (RBTNode*) gp->get_right(); // Uncle
	  ...
	  //Psuedocode lines 1-8
	    ...
	    //Case 2: Z's uncle is black and Z is a right child
	        ...
	        //Case 3: Z's uncle is black and Z is a left child (this will happen regardless)
	      	  p->add_color(BLACK);
	      	  gp->add_color(RED);
	      	  right_rotate(gp);
} 
	...
	//Case 1: Z's uncle is red
	  ...
	  in = (RBTNode*) in->get_parent()->get_parent();
	    ...
	    //Case 2: Z's uncle is black and Z is a left child
	        ...
	        //Case 3: Z's uncle is black and Z is a right child (this will happen regardless)
	          p->add_color(BLACK);
	          gp->add_color(RED);
	          left_rotate(gp);
		// colorshift p and gp, then rotate on gp to make a lower triangle
    }
  }  
} 
p = (RBTNode*) in->get_parent();
